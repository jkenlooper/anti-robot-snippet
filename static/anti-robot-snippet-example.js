...
const secretStuffContainerElement = document.getElementById('secret-stuff-container')
if (secretStuffContainerElement) {
  const antiRobotSnippet = new AntiRobotSnippet(window, secretStuffContainerElement)
